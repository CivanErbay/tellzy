      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-auto w-100 text-center">
            <Col sm={4} className="d-flex flex-row justify-content-end">
            ...
            <Col lg={4} className="d-flex flex-row justify-content-start">
              {auth.currentUser ? (
                <>
                  <Nav.Link className="disabledCursor" href="#social">
                    Social
                  </Nav.Link>
                  <Nav.Link href="/main#home">Overview</Nav.Link>
                  <OverlayTrigger
                    trigger="click"
                    placement="bottom"
                    overlay={
