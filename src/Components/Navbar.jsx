      ...
      <Navbar collapseOnSelect expand="lg" bg="light" variant="light">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="mx-auto w-100 text-center ">
            <Col sm={4} className="d-flex justify-content-center align-items-center mobile-column">
            ...
            <Col lg={4} className="d-flex justify-content-center align-items-center mobile-column">
              {auth.currentUser ? (
                <>
                  <Nav.Link href="/story">New Story</Nav.Link>
                  <Nav.Link href="/main#home">{auth.currentUser.displayName}</Nav.Link>
                  <OverlayTrigger
                    trigger="click"
                    placement="bottom"
                    overlay={
                      <Popover>
                        <Popover.Title as="h3">Sure?</Popover.Title>
                        <Popover.Content>
