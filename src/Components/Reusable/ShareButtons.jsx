...
export default class ShareButtons extends Component {
  ...
  render() {
    ...
    const linkWithCopyText = nextParticipant ? `${nextParticipant.email}'s link` : "Final result link";
        ...
        {!isDesktop ? (
          <>
            <Row className="d-flex justify-content-center align-items-center my-5 w-100 flex-wrap">
              <div className="px-2">
                <WhatsappShareButton url={link} title={title} children={""}>
                  <WhatsappIcon size={45} round={true} />
                </WhatsappShareButton>
              </div>
              <div className="px-2">
                <TelegramShareButton url={link} title={title} children={""}>
                  <TelegramIcon size={45} round={true} />
                </TelegramShareButton>
              </div>
              <div className="px-2">
                <FacebookShareButton url={link} title={title} children={""}>
                  <FacebookIcon size={45} round={true} />
                </FacebookShareButton>
              </div>
              <div className="px-2">
                <TwitterShareButton url={link} title={title} children={""}>
                  <TwitterIcon size={45} round={true} />
                </TwitterShareButton>
              </div>
              <div className="px-2">
                <EmailShareButton url={link} title={title} children={""}>
